...
l = pd.read_csv("smile_labels.csv")

train_csv = open("../causal_data/causal_data/smile/train.csv", 'w', encoding='utf-8', newline="")
test_csv = open("../causal_data/causal_data/smile/test.csv", 'w', encoding='utf-8', newline="")
...
origin_path = "E:\\dataset\\img_celebA_resize\\"
train_path = "E:\\pycharmproject\\GNNProject2\\causal_data\\causal_data\\smile\\train\\"
test_path = "E:\\pycharmproject\\GNNProject2\\causal_data\\causal_data\\smile\\test\\"
